...
public class TripsC implements StarContract {
    ...
    public TripsC(String routeId, String serviceId, String headsign, String directionId, String blockId, String wheelchairAccessible) {
