...
/**
 * Created by hamed on 14/11/2017.
 */
public interface StarContract {

    String AUTHORITY = "fr.istic.starproviderDK"; // Autorité de ce fournisseur
    ...
    interface BusRoutes {
        ...
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fr.istic.starproviderDK.busroute";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.starproviderDK.busroute";
    ...
    interface Trips {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fr.istic.starproviderDK.trip";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.starproviderDK.trip";
    ...
    interface Stops {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fr.istic.starproviderDK.stop";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.starproviderDK.stop";
    ...
    interface StopTimes {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fr.istic.starproviderDK.stoptime";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.starproviderDK.stoptime";
    ...
    interface Calendar {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fr.istic.starproviderDK.calendar";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.starproviderDK.calendar";
